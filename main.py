...
pygame.mixer.init()
alarm_sound = pygame.mixer.Sound("sound/sound1.wav")
...
while True:
    ...
    if frame is not None:
        ...
        cv2.putText(frame, "Left EAR {:.2f}".format(leftEAR), (10, 700),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
        cv2.putText(frame, "Right EAR {:.2f}".format(rightEAR), (10, 740),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
